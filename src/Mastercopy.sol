...
// contract MasterCopy is ERC721, Auth {
...
//     ) ERC721(
//       // e.g. GEB Access
//       string(abi.encodePacked(_name, " Mastercopy")),
//       // at stands for access token
//       string(abi.encodePacked("l", _symbol))
//     )
//     Auth(msg.sender, Auth(msg.sender).authority()) { // the Auth(msg.sender) assumes msg.sender is a contract, and is communicating with it through the Auth interface
//       baseURI = _baseURI;
